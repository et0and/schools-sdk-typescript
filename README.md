...
[![NPM version](<https://img.shields.io/npm/v/schools.svg?label=npm%20(stable)>)](https://npmjs.org/package/schools) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/schools)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/schools-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install schools`
...
```ts
import Schools from 'npm:schools';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/schools-typescript/issues) with questions, bugs, or suggestions.
