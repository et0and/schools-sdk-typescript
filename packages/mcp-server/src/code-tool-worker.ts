...
import { Schools, ClientOptions } from 'schools-sdk';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Schools)`
    : `const run: (${functionSource.client}: Schools) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.schools.byAuthority',
    'client.schools.byCity',
    'client.schools.byStatus',
    'client.schools.bySuburb',
    'client.schools.list',
    'client.schools.retrieve',
    'client.schools.search',
