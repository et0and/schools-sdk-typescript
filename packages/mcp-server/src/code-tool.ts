...
const prompt = `Runs JavaScript code to interact with the Schools API.
...
const remoteStainlessHandler = async ({
  ...
  const localClientEnvs = {
    ...
    SCHOOLS_BASE_URL:
      readEnv('SCHOOLS_BASE_URL') ?? readEnv('SCHOOLS_ENVIRONMENT') ? undefined : client.baseURL ?? undefined,
  };
